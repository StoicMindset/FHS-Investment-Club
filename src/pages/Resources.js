      ...
      <section class="hero is-dark-green is-medium is-bold">
        ...
        <div class="hero-body">
          <div class="container has-text-centered">
            ...
            <p class="subtitle has-text-white">FHS Investment Club</p>
          </div>
        </div>
      </section>
      <div class="content is-normal">
        <div class="hero-body">
          <div class="container has-text-left">
            <h1>Resources</h1>
            <p>
              Use this collection of resources for everything from registering
              for Young Investors' Society to picking and researching stocks on
              your own. If you have any questions on how to access these
            ...
            <h2>YIS</h2>
            <p>
              The club is a chapter of Young Investors' Society, so every member
              needs to be registered in MyYIS. Our school's name is "Franklin
              High School TN".
            </p>
            <ul>
              <li>
            ...
            <p>
              These are the club's recommended brokerages. Fidelity offers $50
              for creating a youth account. Robinhood offers $5-$200 in free
              stock if you use the link provided. Stockpile offers $10 if you
              use the link provided. Of the three, Robinhood is the only one
              that does not offer a custodial account, which means you'll need
              to trade in an adult's name.
            </p>
            <ul>
              <li>
                <a
            ...
            <h2>FHS Investment Club Stock Market Game</h2>
            <p>
              The club runs a competition through the MarketWatch Stock Market
              Game. Each player starts with $1000 to paper trade. The top
              performer each week gets candy at the meeting. The password to
              join the game is "Franklin".
            </p>
            <ul>
              <li>
                <a
            ...
            <p>
              Use these resources to find and evaluate potential stocks to buy.
              Together, these sites can help you do everything from finding a
              stock to setting a price target to selling it for profit.
            </p>
            <ul>
              {" "}
              <li>
              ...
              <li>
                ...
                &nbsp; - Use the number on your Williamson County Public Library
                Card to log in.
              </li>
              <li>
              ...
              <li>
                <p>
                  ...
                  - Available <i>at</i> the Williamson County Public Library.
                  Call Number: R 332.6 STA.
                </p>
              </li>
              <li>
                <p>SEC Filings -</p>
            ...
            <h2>News</h2>
            <p>
              Read articles from these publications to stay up to date on
            ...
            <h2>Books</h2>
            <p>
              These books are excellent resources for learning Value Investing.{" "}
              <i>A Random Walk Down Wall Street</i>, however, is about the
              Efficient Market Hypothesis, it will prove a better resource to
              what Benjamin Graham calls "Defensive Investors".
            </p>
            <ul>
              <li>
                <a
            ...
            <h2>Blogs</h2>
            <p>
              Blogs are a great resource to get the insights of experienced
              investors.
            </p>
            <ul>
              <li>
            ...
            <h2>Podcasts</h2>
            <p>
              Listen to these finance podcasts any time you would normally
              listen to music to learn investing and personal finance.
              Interesting Fact: The Money Guy Show is based in Franklin! Their
              offices are right above Mellow Mushroom.
            </p>
            <ul>
              <li>
